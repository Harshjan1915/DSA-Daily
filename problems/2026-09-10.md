...
nums
 consisting of positive integers and an integer 
k
.
...
longest
 subarray whose prime factor set contains 
at most
...
The distinct prime factors of 10 are 
{2, 5}
.


The distinct prime factors of 12 are 
{2, 3}
.
...
The distinct prime factors of 9 are 
{3}
.


The distinct prime factors of 18 are 
{2, 3}
.
...
The union of these sets is 
{2, 3}
, which contains 2 distinct prime factors.
...
Since 
2 <= 4
, the entire array is valid. Therefore, the answer is 4.
...
Every subarray of length at least 2 has prime factor set 
{2, 3, 5}
, which contains 3 distinct prime factors.
...
Since 
3 > 2
, only subarrays of length 1 are valid. Therefore, the answer is 1.
