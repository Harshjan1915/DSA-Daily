...
i
 ...
 represents the x-coordinate, y-coordinate, and travel range of the 
i
th
 drone.
...
Manhattan distance
 between its coordinates and the target coordinates is 
less than or equal
 to its 
range
i
...
Return the 
index
 of the reachable drone with the 
minimum Manhattan distance
 to the target. If there is a tie, return the 
smallest index
...
Since 
drones[1]
 is the nearest drone, the answer is 1.
...
drones = [[2,1,5],[4,4,5],[6,6,8]], target = [5,5]
...
drones[1]
 and 
drones[2]
 are the nearest drones. Since we should return the smallest index, the answer is 1.
