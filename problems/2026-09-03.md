...
lights
 of length 
n
, representing positions 0 through 
n - 1
 on a road.
...
, where 
v > 0
, there is a working bulb at position 
i
 that 
illuminates
 every position from 
...
If 
lights[i] = 0
, there is no working bulb at position 
i
.
...
additional
 bulbs at 
any
 positions. Each additional bulb installed at position 
j
...
Return the minimum number of additional bulbs required to make 
every
...
Since 
lights[3] = 2
, the working bulb at position 3 illuminates positions 
[1, 2, 3, 4]
.
